    ...
    return Column(
      ...
      children: [
        ...
        ProfileSections(
            sectiontext: "Logout",
            sideicon: Icons.chevron_right,
            svgimageurl: "assets/images/logout.svg",
            onTap: logoutFunction()),
        Constants.lineSection(),
        ProfileSections(
            sectiontext: "Delete User Data",
            sideicon: Icons.chevron_right,
            svgimageurl: "assets/images/deleteu.svg",
